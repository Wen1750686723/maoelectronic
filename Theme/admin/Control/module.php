		...
		<form role="form" method="post" action="<?php echo U('user/index/site_control'); ?>">
			<div class="form-group">
				        ...
				        <label class="radio-inline">
							<input type="radio" name="home_mode" value="post" <?php if(mc_option('home_mode')=='post') : ?>checked<?php endif; ?>>
							社区
						</label>
				        <label class="radio-inline">
							<input type="radio" name="home_mode" value="pro" <?php if(mc_option('home_mode')=='pro') : ?>checked<?php endif; ?>>
							商品
						</label>
				    </div>
					<div class="form-group">
