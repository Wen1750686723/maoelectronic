			...
			<div class="col-lg-12">
				...
				<form role="form" method="post" action="<?php echo mc_page_url(); ?>">
				    ...
				    <div class="form-group">
				        ...
				        <div class="row">
				        	<div class="col-md-4 col-lg-3">
						        ...
						        <?php $dir = THINK_PATH."../Theme"; if (is_dir($dir)) : if ($dh = opendir($dir)) : while (($file = readdir($dh))!= false) : $filePath = $dir.'/'.$file; if (is_dir($filePath)) : if($file!='.' && $file!='..' && $file!='admin') : ?>
				    ...
				    <div class="form-group">
						...
						<div class="row">
							<div class="col-sm-6" id="pub-logoadd">
								...
								<input type="hidden" name="logo" id="pub-input2" value="<?php if(mc_option('logo')) : echo mc_option('logo'); else : ?><?php echo mc_theme_url(); ?>/img/logo-s.png<?php endif; ?>">
					...
					function readFile(obj,id){ 
				        ...
				        reader.onload = function(e){ 
				        	if(id==1) {
								...
								$('#pub-imgadd-1 input.mb-10').val(this.result);
							} else if(id==4) {
					        	$('#pub-imgadd-2 .default-img').attr('src',this.result);
								$('#pub-imgadd-2 input.mb-10').val(this.result);
							} else if(id==5) {
					        	$('#pub-imgadd-3 .default-img').attr('src',this.result);
								$('#pub-imgadd-3 input.mb-10').val(this.result);
							}
				            //alert(this.result);
				        } 
				} 
				    ...
				    <div class="form-group">
				        ...
				        <p class="help-block">请确认文件<code>connect-qq/API/comm/inc.php</code>可写</p>
				    </div>
				    <div class="form-group">
				        <label>
				            新浪微博快速登陆
