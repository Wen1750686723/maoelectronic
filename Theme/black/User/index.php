...
<?php mc_template_part('head-user'); ?>
	<div class="container">
		...
		<div id="home-main-u" class="home-main">
			<div class="row">
				<div class="col-md-8 col-lg-9" id="post-list-default-user">
					<h4 class="title">
							...
							<div class="media-body">
								<h4 class="media-heading mb-10">
									...
									<?php elseif($key=='publish') :
										...
										<?php elseif($type=='baobei') : ?>
										分享了宝贝 <a href="<?php echo mc_get_url($page_id); ?>"><?php echo mc_get_page_field($page_id,'title'); ?></a>：
										<?php elseif($type=='pro') : ?>
				...
				<div class="col-md-4 col-lg-3 hidden-xs hidden-sm home-side">
							...
							<li class="list-group-item">
								<div class="media">
									...
									<div class="media-body">
										...
										<a href="<?php echo U('home/perform/add_cart','id='.$val['id'].'&number=1'); ?>" class="btn btn-primary btn-xs">
								...
								<div class="media">
									<a class="media-left" href="<?php echo mc_get_url($author); ?>">
										<div class="img-div post">
											<img src="<?php echo mc_user_avatar($author); ?>" alt="<?php echo mc_user_display_name($author); ?>">
										</div>
									</a>
									<div class="media-body">
										<h4 class="media-heading">
										...
										<p class="mb-0">
											<?php echo mc_cut_str(strip_tags(mc_get_page_field($val['id'],'content')), 14); ?>
										</p>
									</div>
								</div>
							</li>
					...
					<div class="panel panel-default">
						...
						<div class="list-group">
							...
							<a href="<?php echo mc_get_url($val['id']); ?>" class="list-group-item wto">
								<?php echo $val['title']; ?>
							</a>
							<?php endforeach; ?>
						</div>
